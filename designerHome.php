    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        echo "<main>
                ...
                <div class='organize'>
                    <div id='personalinfo'>
                        ...
                        <img id='logo' src='Designerlogo/$logoImgFileName' alt='logo'>
                        <h4>First Name:</h4>
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            if ($row['status'] === 'Pending Consultation') {
                $requestId = $row['id'];
                $acceptLink = "DesignConsultation.php?request_id=$requestId"; // Code-generated link based on request ID
                ...
                <td>$date</td>
                <td><a href='$acceptLink'>Provide</a></td>
